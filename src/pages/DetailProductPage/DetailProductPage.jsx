...
import { Input, Button, Upload, message, Row, Col, Select, InputNumber, Form, Switch } from "antd";
...
const ProductDetailForm = () => {
  ...
  const handleAddAttribute = () => {
    const updatedAttributes = [...productDetails.attributes, { type: "", value: "" }];
  ...
  const handleSaveProduct = () => {
    ...
    setIsModified(false); // Reset trạng thái sau khi lưu
  };
    ...
    <div>
      ...
      <div className="product-detail">
        ...
        <div className="section">
          ...
          {productDetails.attributes.map((attr, index) => (
            <Row gutter={16} key={index} align="middle">
              ...
              <Col span={1}>
                <div className="label-box-group">
                  ...
                  <Switch
                    ...
                    onChange={(checked) => handleAttributeActiveChange(index, checked)}
                  />
                </div>
              </Col>
              <Col span={24}>
              <div className="label-box-group">
                ...
                <label>Trạng thái:</label>
                  <Select
                    ...
                    onChange={(value) => handleAttributeChange(index, { target: { name: "status", value } })}
                  >
              ...
              <label>Hình ảnh:</label>
                <Upload
                  listType="picture-card"
                  fileList={attr.attributeImage ? [{ url: attr.attributeImage }] : []}  // Hiển thị hình ảnh nếu có
          ...
          <Button type="dashed" icon={<PlusOutlined />} onClick={handleAddAttribute} style={{backgroundColor:  '#cdd1ff', color: '#091057', border: 'none'}}>
            Thêm biến thể
          </Button>
        </div>
